...
export function PublicBottomNav() {
  ...
  return (
    ...
    >
      <ul className="mx-auto grid h-16 w-full max-w-3xl grid-cols-3 px-2">
        {items.map((item) => {
          ...
          return (
            <li key={item.href}>
              <Link
                ...
                className={`flex h-full w-full flex-col items-center justify-center gap-1 rounded-lg text-xs font-semibold ${
